...
namespace SudokuTester
{
    class Program
    {
        //public static int[,] testNumber1 = { { 3, 4, 1, 2 }, { 1, 2, 4, 3 }, { 2, 1, 3, 4 }, { 4, 3, 2, 1 } };
        //public static int[,] testNumber2 = { { 2, 1, 4, 3 }, { 4, 3, 2, 1 }, { 1, 2, 3, 4 }, { 3, 4, 1, 2 } };
        //public static int[,] testNumber3 = { { 1, 2, 3, 4 }, { 4, 3, 1, 2 }, { 2, 1, 4, 3 }, { 3, 4, 2, 1 } };
        //public static int[,] testNumber4 = { { 4, 3, 1, 2 }, { 2, 1, 3, 4 }, { 3, 4, 2, 1 }, { 1, 2, 4, 3 } };
        ...
        static void Main(string[] args)
        {
            ...
            var testNumberArrays = new[] { Sudoku.testNumber1, Sudoku.testNumber2, Sudoku.testNumber3, Sudoku.testNumber4 };

            Console.WriteLine(testNumberArrays[1].Length);
            ...
            for (int main = 0; main < 4; main++)
            {
                ...
                for (int x = 1; x <= 4; x++)
                {
                    for (int y = 1; y <= 4; y++)
                    {
                        ...
                        //Console.WriteLine($"O({x},{y})\t placed on {}\t and has a value of {}\t is  {}\t");
