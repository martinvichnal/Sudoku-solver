...
namespace SudokuTester
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Sudoku.sudokuNumbers[Sudoku.GetNumer(0,2)]);
            ...
            while (meddig)
            {
                ...
                {
                    Console.WriteLine($"x: "); x = int.Parse(Console.ReadLine());
                    Console.WriteLine($"y: "); y = int.Parse(Console.ReadLine());
                    Console.WriteLine($"Az eredmeny{Sudoku.GetNumer(x, y)}");
                    Console.WriteLine();
                }
            }
        }
