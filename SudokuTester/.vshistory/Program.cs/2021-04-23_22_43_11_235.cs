...
namespace SudokuTester
{
    class Program
    {
        public static int[,] testNumber1 = { { 3, 4, 1, 2 }, { 1, 2, 4, 3 }, { 2, 1, 4, 4 }, { 4, 3, 2, 1 } };      // Test 2D Matrix Numbers 
        ...
        static void Main(string[] args)
        {
            ...
            for (int x = 0; x < 4; x++)
            {
                for (int y = 0; y < 4; y++)
                {
                    ...
                    Console.WriteLine($"O({x},{y})\t placed on ...\t and has a value of {testNumber1[x, y]}\t is {Sudoku.CheckingForRight(x, y)}\t");
