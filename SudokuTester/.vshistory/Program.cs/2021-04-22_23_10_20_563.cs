...
namespace SudokuTester
{
    class Program
    {
        ...
        // int[,] testNumber1 = { { 3, 4, 1, 2 }, { 1, 2, 4, 3 }, { 2, 1, 3, 4 }, { 4, 3, 2, 1 } };
        // int[,] testNumber2 = { { 2, 1, 4, 3 }, { 4, 3, 2, 1 }, { 1, 2, 3, 4 }, { 3, 4, 1, 2 } };
        // int[,] testNumber3 = { { 1, 2, 3, 4 }, { 4, 3, 1, 2 }, { 2, 1, 4, 3 }, { 3, 4, 2, 1 } };
        // int[,] testNumber4 = { { 4, 3, 1, 2 }, { 2, 1, 3, 4 }, { 3, 4, 2, 1 }, { 1, 2, 4, 3 } };
        ...
        static void Main(string[] args)
        {
            ...
            {
                Sudoku.gridSize = testNumberArrays[main].Length;
                ...
                for (int x = 1; x <= 4; x++)
                {
                    for (int y = 1; y <= 4; y++)
                    {
                        ...
                        Console.WriteLine($"O({x},{y})\t placed on {Sudoku.GetNumber(x, y)}\t and has a value of {}\t is  {}\t");
