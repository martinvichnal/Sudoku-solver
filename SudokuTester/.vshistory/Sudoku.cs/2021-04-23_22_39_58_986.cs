    ...
    class Sudoku
    {
        ...
        public static bool CheckingForRight(int x, int y)
        {
            ...
            while (isThereSomethingVertical)
            {
                ...
                {
                    // [x - 1, y - 1]
                    //if (Program.testNumber1[y - 1, x - 1] == Program.testNumber1[Upper - 1, x - 1])
                    //{
                    //    problemCount++;
                    //    isFoundProblem = true;
                    //}
                    if (Program.testNumber1[y, x] == Program.testNumber1[yUpper, x])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
            ...
            while (isThereSomethingVertical)
            {
                ...
                {
                    //if (Program.testNumber1[y - 1, x - 1] == Program.testNumber1[Lower - 1, x - 1])
                    //{
                    //    problemCount++;
                    //    isFoundProblem = true;
                    //}
                    if (Program.testNumber1[y, x] == Program.testNumber1[yLower, x])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
            ...
            while (isThereSomethingHorizontal)
            {
                ...
                {
                    //if (Program.testNumber1[y - 1, x - 1] == Program.testNumber1[y - 1, Right - 1])
                    //{
                    //    problemCount++;
                    //    isFoundProblem = true;
                    //}
                    if (Program.testNumber1[y, x] == Program.testNumber1[y, xRight])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
            ...
            while (isThereSomethingHorizontal)
            {
                ...
                {
                    //if (Program.testNumber1[y - 1, x - 1] == Program.testNumber1[y - 1, Left - 1])
                    //{
                    //    problemCount++;
                    //    isFoundProblem = true;
                    //}
                    if (Program.testNumber1[y, x] == Program.testNumber1[y, xLeft])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
