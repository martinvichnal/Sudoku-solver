...
namespace SudokuTester
{
    class Sudoku
    {
        ...
        public static int sqrtGrid { get; set; }
        ...
        public static var testNumberArrays = new[] { testNumber1, testNumber2, testNumber3, testNumber4 };
        ...
        public static int GetNumer(int x, int y)
        {
            ...
            sqrtGrid = Convert.ToInt32(Math.Sqrt(sudokuNumbers.Count));
