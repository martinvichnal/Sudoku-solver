    ...
    class Sudoku
    {
        ...
        public static bool CheckingForRight(int x, int y)
        {
            ...
            while (isThereSomethingVertical)
            {
                ...
                {
                    if (Program.testNumber1[x - 1, y - 1] == Program.testNumber1[x - 1, Upper - 1])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
            ...
            while (isThereSomethingVertical)
            {
                ...
                {
                    if (Program.testNumber1[x - 1, y - 1] == Program.testNumber1[x - 1, Lower - 1])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
            ...
            while (isThereSomethingHorizontal)
            {
                ...
                {
                    if (Program.testNumber1[x - 1,y - 1] == Program.testNumber1[x - 1, Right - 1])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
            ...
            while (isThereSomethingHorizontal)
            {
                ...
                {
                    if (Program.testNumber1[x - 1, y - 1] == Program.testNumber1[x - 1, Left - 1])
                    {
                        problemCount++;
                        isFoundProblem = true;
                    }
